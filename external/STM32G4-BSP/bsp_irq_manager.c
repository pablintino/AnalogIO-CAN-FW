...
{
    interrupt_handler(WWDG_IRQn);
}

void BSP_IntHandlerPVD(void)
{
    interrupt_handler(PVD_PVM_IRQn);
}

void BSP_IntHandlerTMP_STMP(void)
{
    interrupt_handler(RTC_TAMP_LSECSS_IRQn);
}

void BSP_IntHandlerRTC_WKUP(void)
{
    interrupt_handler(RTC_WKUP_IRQn);
}

void BSP_IntHandlerFLASH(void)
{
    interrupt_handler(FLASH_IRQn);
}

void BSP_IntHandlerRCC(void)
{
    interrupt_handler(RCC_IRQn);
}

void BSP_IntHandlerEXTI0(void)
{
    interrupt_handler(EXTI0_IRQn);
}

void BSP_IntHandlerEXTI1(void)
{
    interrupt_handler(EXTI1_IRQn);
}

void BSP_IntHandlerEXTI2(void)
{
    interrupt_handler(EXTI2_IRQn);
}

void BSP_IntHandlerEXTI3(void)
{
    interrupt_handler(EXTI3_IRQn);
}

void BSP_IntHandlerEXTI4(void)
{
    interrupt_handler(EXTI4_IRQn);
}

void BSP_IntHandlerDMA1_CH1(void)
{
    interrupt_handler(DMA1_Channel1_IRQn);
}

void BSP_IntHandlerDMA1_CH2(void)
{
    interrupt_handler(DMA1_Channel2_IRQn);
}

void BSP_IntHandlerDMA1_CH3(void)
{
    interrupt_handler(DMA1_Channel3_IRQn);
}

void BSP_IntHandlerDMA1_CH4(void)
{
    interrupt_handler(DMA1_Channel4_IRQn);
}

void BSP_IntHandlerDMA1_CH5(void)
{
    interrupt_handler(DMA1_Channel5_IRQn);
}

void BSP_IntHandlerDMA1_CH6(void)
{
    interrupt_handler(DMA1_Channel6_IRQn);
}

void BSP_IntHandlerADC1_2(void)
{
    interrupt_handler(ADC1_2_IRQn);
}

void BSP_IntHandlerUSB_HP(void)
{
    interrupt_handler(USB_HP_IRQn);
}

void BSP_IntHandlerUSB_LP(void)
{
    interrupt_handler(USB_LP_IRQn);
}

void BSP_IntHandlerFDCAN1_IT0(void)
{
    interrupt_handler(FDCAN1_IT0_IRQn);
}

void BSP_IntHandlerFDCAN1_IT1(void)
{
    interrupt_handler(FDCAN1_IT1_IRQn);
}

void BSP_IntHandlerEXTI9_5(void)
{
    interrupt_handler(EXTI9_5_IRQn);
}

void BSP_IntHandlerTIM1_BRK_TIM15(void)
{
    interrupt_handler(TIM1_BRK_TIM15_IRQn);
}

void BSP_IntHandlerTIM1_UP_TIM16(void)
{
    interrupt_handler(TIM1_UP_TIM16_IRQn);
}

void BSP_IntHandlerTIM1_TRG_COM_TIM17(void)
{
    interrupt_handler(TIM1_TRG_COM_TIM17_IRQn);
}

void BSP_IntHandlerTIM1_CC(void)
{
    interrupt_handler(TIM1_CC_IRQn);
}

void BSP_IntHandlerTIM2(void)
{
    interrupt_handler(TIM2_IRQn);
}

void BSP_IntHandlerTIM3(void)
{
    interrupt_handler(TIM3_IRQn);
}

void BSP_IntHandlerTIM4(void)
{
    interrupt_handler(TIM4_IRQn);
}

void BSP_IntHandlerI2C1_EV(void)
{
    interrupt_handler(I2C1_EV_IRQn);
}

void BSP_IntHandlerI2C1_ER(void)
{
    interrupt_handler(I2C1_ER_IRQn);
}

void BSP_IntHandlerI2C2_EV(void)
{
    interrupt_handler(I2C2_EV_IRQn);
}

void BSP_IntHandlerI2C2_ER(void)
{
    interrupt_handler(I2C2_ER_IRQn);
}

void BSP_IntHandlerSPI1(void)
{
    interrupt_handler(SPI1_IRQn);
}

void BSP_IntHandlerSPI2(void)
{
    interrupt_handler(SPI2_IRQn);
}

void BSP_IntHandlerUSART1(void)
{
    interrupt_handler(USART1_IRQn);
}

void BSP_IntHandlerUSART2(void)
{
    interrupt_handler(USART2_IRQn);
}

void BSP_IntHandlerUSART3(void)
{
    interrupt_handler(USART3_IRQn);
}

void BSP_IntHandlerEXTI15_10(void)
{
    interrupt_handler(EXTI15_10_IRQn);
}

void BSP_IntHandlerRTC_ALARM(void)
{
    interrupt_handler(RTC_Alarm_IRQn);
}

void BSP_IntHandlerUSB_WKUP(void)
{
    interrupt_handler(USBWakeUp_IRQn);
}

void BSP_IntHandlerTIM8_BRK(void)
{
    interrupt_handler(TIM8_BRK_IRQn);
}

void BSP_IntHandlerTIM8_UP(void)
{
    interrupt_handler(TIM8_UP_IRQn);
}

void BSP_IntHandlerTIM8_TRG_COM(void)
{
    interrupt_handler(TIM8_TRG_COM_IRQn);
}

void BSP_IntHandlerTIM8_CC(void)
{
    interrupt_handler(TIM8_CC_IRQn);
}

void BSP_IntHandlerLPTIM1(void)
{
    interrupt_handler(LPTIM1_IRQn);
}

void BSP_IntHandlerSPI3(void)
{
    interrupt_handler(SPI3_IRQn);
}

void BSP_IntHandlerTIM6_DAC1(void)
{
    interrupt_handler(TIM6_DAC_IRQn);
}

void BSP_IntHandlerDMA2_CH1(void)
{
    interrupt_handler(DMA2_Channel1_IRQn);
}

void BSP_IntHandlerDMA2_CH2(void)
{
    interrupt_handler(DMA2_Channel2_IRQn);
}

void BSP_IntHandlerDMA2_CH3(void)
{
    interrupt_handler(DMA2_Channel3_IRQn);
}

void BSP_IntHandlerDMA2_CH4(void)
{
    interrupt_handler(DMA2_Channel4_IRQn);
}

void BSP_IntHandlerDMA2_CH5(void)
{
    interrupt_handler(DMA2_Channel5_IRQn);
}

void BSP_IntHandlerUCPD1(void)
{
    interrupt_handler(UCPD1_IRQn);
}

void BSP_IntHandlerCOMP1_3(void)
{
    interrupt_handler(COMP1_2_3_IRQn);
}

void BSP_IntHandlerCRS(void)
{
    interrupt_handler(CRS_IRQn);
}

void BSP_IntHandlerSAI(void)
{
    interrupt_handler(SAI1_IRQn);
}

void BSP_IntHandlerFPU(void)
{
    interrupt_handler(FPU_IRQn);
}

void BSP_IntHandlerRNG(void)
{
    interrupt_handler(RNG_IRQn);
}

void BSP_IntHandlerLPUART1(void)
{
    interrupt_handler(LPUART1_IRQn);
}

void BSP_IntHandlerI2C3_EV(void)
{
    interrupt_handler(I2C3_EV_IRQn);
}

void BSP_IntHandlerI2C3_ER(void)
{
    interrupt_handler(I2C3_ER_IRQn);
}

void BSP_IntHandlerDMAMUX_OVR(void)
{
    interrupt_handler(DMAMUX_OVR_IRQn);
}

void BSP_IntHandlerDMA2_CH6(void)
{
    interrupt_handler(DMA2_Channel6_IRQn);
}

void BSP_IntHandlerCORDIC(void)
{
    interrupt_handler(CORDIC_IRQn);
}

void BSP_IntHandlerFMAC(void)
{
    interrupt_handler(FMAC_IRQn);
}
...
{
    interrupt_handler(TIM7_IRQn);
}

void BSP_IntHandlerCOMP4(void)
{
    interrupt_handler(COMP4_IRQn);
}
