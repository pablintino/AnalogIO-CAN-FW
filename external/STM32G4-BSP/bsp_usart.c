...
static uint32_t __calculate_brr(uint32_t usart_clk,
                                uint32_t baudrate,
                                uint16_t prescaler,
                                enum busart_sampling_e sampling);
...
static inline bool __is_valid_prescaler(bsp_usart_prescaler prescaler)
{
